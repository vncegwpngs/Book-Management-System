...
namespace BookManagementSystemV2
{
    class Program
    {
        static void Main(string[] args)
        {
            string optionSelected = "okay", bookInfo, borrowerInfo, dateInfo, editedInfo, returnedBook, borrower, dateReturned;
            ...
            else
            {
                ...
                do
                {
                    ...
                    Console.WriteLine("3. Returned Books Informtaion");
                    ...
                    if (choice == "3")
                    {
                        ...
                        Console.Write("Enter the Returned Book's name: ");
                        returnedBook = Console.ReadLine();

                        Console.Write("Enter Borrower's name: ");
                        borrower = Console.ReadLine();

                        Console.Write("Enter the date Returned: ");
                        dateReturned = Console.ReadLine();

                        Console.WriteLine("\nThe book " + returnedBook + " was returned.");
                        Console.WriteLine("Borrower's Name: " + borrower);
                        Console.WriteLine("Date Returned: " + dateReturned);
